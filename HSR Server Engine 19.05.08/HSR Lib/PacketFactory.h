...
public:
    Packet* getPacket(Int64 packetType) 
    {
        switch (packetType) {
			...
			case E_C_REQ_MOVING:	return new PK_C_REQ_MOVING();
			case E_S_ANS_MOVING:	return new PK_S_ANS_MOVING();
			case E_C_REQ_GAME_NAME: return new PK_C_REQ_GAME_NAME();
			case E_C_REQ_ENEMY_NOTEHIT: return new PK_C_REQ_ENEMY_NOTEHIT();
			case E_C_REQ_GAME_CONNECT: return new PK_C_REQ_GAME_CONNECT();
			case E_S_ANS_GAME_CONNECT: return new PK_S_ANS_GAME_CONNECT();
			case E_C_REQ_GAME_CONNECT_CANCEL: return new PK_C_REQ_GAME_CONNECT_CANCEL();
			case E_C_REQ_EXIT_GAME: return new PK_C_REQ_EXIT_GAME();
        }
        return nullptr;
    }
};
